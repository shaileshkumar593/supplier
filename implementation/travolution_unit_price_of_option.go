...
func (s *service) GetUnitSPriceByOptionUid(ctx context.Context, req travolution.UnitPriceRequest) (resp travolution.Response, err error) {
	...
	logger := log.With(
		s.logger,
		"method", "GetUnitSPriceByOptionUid",
	...
	resp, err = tsvc.GetUnits(ctx, req)
	if err != nil {
...
func (s *service) GetUnitPriceByOptionUid(ctx context.Context, req travolution.UnitPriceRequest) (resp travolution.Response, err error) {
	var requestID string
	...
	logger := log.With(
		s.logger,
		"method", "GetUnitPriceByOptionUid",
		"Request ID", requestID,
	)
	// Defer panic recovery
	defer func(ctx context.Context) {
